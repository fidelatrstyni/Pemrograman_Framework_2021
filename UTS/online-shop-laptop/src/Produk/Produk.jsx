...
class produk extends Component {
    ...
    handleTambahProduk = (data) => {
        ...
        .then(response => response.json())
        .then(res => {
            var produkLaptop = { ...this.state.insertProduk };
            produkLaptop["id"] = res["id"];
            produkLaptop["nama"] = res["nama"];
            produkLaptop["harga"] = res["harga"];
            produkLaptop["stok"] = res["stok"];
            produkLaptop["qty"] = 0;
            this.setState({
                insertProduk: produkLaptop
            });
        })
        .then(() =>{
