            ...
            <div className='row justify-content-center'>
              <div className='col-md-12'>
                        ...
                        <div className='card shadow-lg p-3 mb-5 bg-white rounded'>
                            <div className='card-header bg-white' style={{ textAlign: 'center', fontSize: 30 }}> <BiPalette />Rekomendasi Wisata Yogyakarta</div>
                ...
                <div className='card shadow-lg p-3 mb-5 bg-white rounded'>
                  <div className='card-header bg-white' style={{textAlign:'center', fontSize:30}}><BiPalette />Artikel Tempat Wisata Yogyakarta</div>
                  <div className='card-body'>
                    <Link className='btn btn-primary btn-sm mb-3' to='/create'>
                        <BiPlus />Create new article
                    </Link>
